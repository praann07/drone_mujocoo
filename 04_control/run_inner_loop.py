...
from run_identification import fit_models  # noqa: E402
from run_validation import linearize_sindy_at_hover  # noqa: E402

PROJECT_ROOT = Path(__file__).resolve().parent.parent
PLOTS_DIR = PROJECT_ROOT / "data" / "processed" / "control_plots"
...
def run_all() -> pd.DataFrame:
    ...
    df.to_csv(PLOTS_DIR / "inner_loop_results.csv", index=False)
