...
from run_identification import DT, RAW_DIR, consecutive_pairs, evaluate_one_step, fit_models, r2, stack  # noqa: E402
from sindy_fit import SINDyModel  # noqa: E402

PROJECT_ROOT = Path(__file__).resolve().parent.parent
PROCESSED_DIR = PROJECT_ROOT / "data" / "processed"
PLOTS_DIR = PROCESSED_DIR / "validation_plots"
...
def run_rollout_suite(fitted: dict) -> pd.DataFrame:
    ...
    df.to_csv(PLOTS_DIR / "rollout_results.csv", index=False)
...
def freeze_selected_model(fitted: dict, selected: str, A_sindy: np.ndarray) -> None:
    ...
    np.savez(
        ...
        frozen_from="03_validation.run_validation",
    )
